...
@section('content')
    <div>
        <div class="container py-24">
            <div class="flex flex-col gap-12 justify-center text-center">
                ...
                @if($errors->all())
                        ...
                        @endforeach
                @endif
                <form action="{{route('auth.register')}}" method="post" class="flex flex-col justify-center gap-7 items-center">
                    @csrf
