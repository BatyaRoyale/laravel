<footer class="border-t border-white border-opacity-25">
    <div class="container py-5 flex flex-wrap items-center justify-between gap-7 ">
        ...
        <ul class="flex items-center gap-14 text-base">
            <li><a href="" class="h-5 hover:border-b border-white pb-2 transition ease-in-out delay-300">Главная</a></li>
            <li><a href="" class="h-5 hover:border-b border-white pb-2 transition">Каталог</a></li>
